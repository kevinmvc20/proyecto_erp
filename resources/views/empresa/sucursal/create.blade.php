    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('sucursales.store') }}" method="POST" autocomplete="off">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="encargado" name="encargado" placeholder="Encargado..."
                    class=" w-2/4 p-2 border border-gray-300 rounded" pattern="^[a-zA-Z0-9_áéíóúñÁÉÍÓÚÑ°\s]{0,200}"
                    value="{{ old('encargado') }}">
                @error('encargado')
            ...
            <div class="mb-4">
                <label for="nombre" class="block font-medium">Nombre Sucursal:</label>
                ...
                <div class="relative">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg class="w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            ...
                            <path
                                d="M7.293 9.293a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L10 10.414l-2.293 2.293a1 1 0 01-1.414-1.414l3-3z" />
                        </svg>
                    </div>
                </div>
                @error('empresa_id')
